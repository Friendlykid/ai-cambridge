...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    * Please read learningAgents.py before reading this.*
    ...
    def runValueIteration(self):
        ...
        for _ in range(self.iterations):
            ...
            for state in states:
                ...
                actions = list(self.mdp.getPossibleActions(state) or ())
                if not actions:
                    updated_values[state] = 0
                    continue
                ...
                for action in actions:
                    ...
                    for next_state, probability in self.mdp.getTransitionStatesAndProbs(
                        ...
                        q_value += probability * (
                            reward + self.discount * previous_values[next_state]
                        )
    ...
    def computeQValueFromValues(self, state, action):
        ...
        """
        q_value = 0
        transitions = self.mdp.getTransitionStatesAndProbs(state, action) or ()
