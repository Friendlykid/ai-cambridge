...
def uniformCostSearch(problem: SearchProblem) -> List[Directions]:
    ...
    while not frontier.isEmpty():
        ...
        for successor, action, stepCost in problem.getSuccessors(state):
            ...
            if successor not in bestCosts or nextCost < bestCosts[successor]:
                bestCosts[successor] = nextCost
                frontier.push((successor, actions + [action], nextCost), nextCost)
    ...
    while not frontier.isEmpty():
        ...
        for successor, action, stepCost in problem.getSuccessors(state):
            ...
            if successor not in bestCosts or nextCost < bestCosts[successor]:
                ...
                frontier.push((successor, actions + [action], nextCost), priority)
